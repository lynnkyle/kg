...
if not args.no_write:
    os.makedirs(f'absolution/ckpt/prev-align/{args.model}/{args.data}', exist_ok=True)
    os.makedirs(f'absolution/prev-align/{args.model}/{args.data}', exist_ok=True)
...
file_handler = logging.FileHandler(f'absolution/prev-align/{args.model}/{args.data}/log.log')
    ...
    if (epoch + 1) * 4 % args.valid_epoch == 0:
        ...
        if mrr > best_mrr:
            ...
            torch.save({'state_dict': model.state_dict(), 'optimizer': optimizer.state_dict(),
                       ...
                       f'absolution/ckpt/prev-align/{args.model}/{args.data}/{epoch + 1}.ckpt')
