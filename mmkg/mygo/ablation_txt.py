...
if not args.no_write:
    os.makedirs(f'absolution/txt/ckpt/{args.model}/{args.data}', exist_ok=True)
    os.makedirs(f'absolution/txt/log/{args.model}/{args.data}', exist_ok=True)
...
file_handler = logging.FileHandler(f'absolution/txt/log/{args.model}/{args.data}/log.log')
    ...
    if (epoch + 1) * 2 % args.valid_epoch == 0:
        ...
        if mrr > best_mrr:
            ...
            torch.save({'state_dict': model.state_dict(), 'optimizer': optimizer.state_dict(),
                       ...
                       f'absolution/txt/ckpt/{args.model}/{args.data}/{epoch + 1}.ckpt')
